...
insert into `sys_attachment_type` (`id`, `code`, `label`, `title`, `description`)
values (1, 'UNSPECIFIED', 'label_attachment_type__unspecified', '未指定', '未指定'),
       (2, 'USER_AVATAR', 'label_attachment_type__user_avatar', '用户头像', '用户头像');
