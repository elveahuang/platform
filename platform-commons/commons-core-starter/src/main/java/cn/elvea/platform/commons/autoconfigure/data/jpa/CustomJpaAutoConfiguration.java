package cn.elvea.platform.commons.autoconfigure.data.jpa;

import cn.elvea.platform.commons.autoconfigure.data.jpa.properties.CustomJpaProperties;
import cn.elvea.platform.commons.data.jpa.id.CustomIdentifierGenerator;
