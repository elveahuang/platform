...
public class HttpAutoConfiguration {
    ...
    public HttpFactory httpManger(HttpProperties properties) {
        HttpFactory http = HttpFactory.builder().debug(properties.getDebug()).proxy(properties.getProxy()).type(properties.getType()).build();
