...
allprojects {
    ...
    dependencyManagement {
        imports {
            ...
            mavenBom("io.grpc:grpc-bom:1.61.0")
            mavenBom("cn.hutool:hutool-bom:5.8.25")
            mavenBom("me.ahoo.cosid:cosid-bom:2.6.4")
        ...
        dependencies {
            ...
            dependency("org.redisson:redisson:3.26.0")
            dependency("org.redisson:redisson-spring-data-32:3.26.0")
            dependency("org.redisson:redisson-spring-boot-starter:3.26.0")
            // others
            ...
            dependency("com.alibaba:fastjson:2.0.45")
            ...
            dependency("joda-time:joda-time:2.12.6")
            dependency("com.github.oshi:oshi-core-java11:6.4.11")
            ...
            dependency("net.bytebuddy:byte-buddy:1.14.11")
            dependency("net.bytebuddy:byte-buddy-agent:1.14.11")
            ...
            dependency("org.apache.pdfbox:pdfbox:3.0.1")
            dependency("net.coobird:thumbnailator:0.4.20")
            dependency("net.imagej:ij:1.54h")
            ...
            dependency("com.aliyun:tea-openapi:0.3.1")
            dependency("com.aliyun:tea-rpc:0.1.3")
            dependency("com.aliyun:tea-rpc-util:0.1.3")
            dependency("com.aliyun:dingtalk:2.0.77")
            ...
            dependency("com.alipay.sdk:alipay-sdk-java:4.38.192.ALL")
            dependency("com.qcloud:cos_api:5.6.197")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.952")
            ...
            dependency("org.webjars.npm:bootstrap-icons:1.11.2")
        }
    }
