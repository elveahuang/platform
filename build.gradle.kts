...
allprojects {
    ...
    dependencyManagement {
        imports {
            ...
            mavenBom("com.alibaba.cloud:spring-cloud-alibaba-dependencies:2023.0.0.0-RC1")
            mavenBom("com.tencent.cloud:spring-cloud-tencent-dependencies:1.13.1-2023.0.0")
            ...
            mavenBom("com.baomidou:mybatis-plus-bom:3.5.5")
        }

        dependencies {
            // spring authorization server
            dependency("org.springframework.security:spring-security-oauth2-authorization-server:1.2.3")
            // mapstruct & lombok
            ...
            dependency("io.swagger.core.v3:swagger-core-jakarta:2.2.20")
            dependency("io.swagger.core.v3:swagger-annotations:2.2.20")
            dependency("io.swagger.core.v3:swagger-annotations-jakarta:2.2.20")
            dependency("io.swagger.core.v3:swagger-models:2.2.20")
            dependency("io.swagger.core.v3:swagger-models-jakarta:2.2.20")
            dependency("org.springdoc:springdoc-openapi-starter-common:2.4.0")
            dependency("org.springdoc:springdoc-openapi-starter-webmvc-ui:2.4.0")
            dependency("org.springdoc:springdoc-openapi-starter-webflux-ui:2.4.0")
            // database & nosql
            ...
            dependency("com.nimbusds:oauth2-oidc-sdk:11.10.1")
            dependency("org.json:json:20240303")
            dependency("com.alibaba:fastjson:2.0.47")
            ...
            dependency("net.bytebuddy:byte-buddy:1.14.12")
            dependency("net.bytebuddy:byte-buddy-agent:1.14.12")
            dependency("org.bouncycastle:bcpkix-jdk18on:1.77")
            dependency("org.bouncycastle:bcprov-jdk18on:1.77")
            dependency("org.bouncycastle:bcutil-jdk18on:1.77")
            ...
            // sdks
            dependency("io.minio:minio:8.5.9")
            ...
            dependency("com.alibaba:dashscope-sdk-java:2.11.0")
            dependency("com.aliyun:aliyun-java-sdk-core:4.6.4")
            dependency("com.aliyun:tea-openapi:0.3.2")
            dependency("com.aliyun:tea-rpc:0.1.3")
            dependency("com.aliyun:tea-rpc-util:0.1.3")
            dependency("com.aliyun:dingtalk:2.0.95")
            dependency("com.aliyun:imm20170906:1.23.8")
            dependency("com.aliyun:facebody20191230:5.1.1")
            ...
            dependency("com.alipay.sdk:alipay-sdk-java:4.39.2.ALL")
            dependency("com.qcloud:cos_api:5.6.205")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.982")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-kms:3.1.977")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-sms:3.1.962")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-tmt:3.1.967")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-iai:3.1.978")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-hunyuan:3.1.977")
            dependency("com.larksuite.oapi:oapi-sdk:2.2.1")
