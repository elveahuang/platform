...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            // sdk - aliyun
            dependency("com.aliyun:dingtalk:2.1.68")
            dependency("com.aliyun:ecs20140526:5.4.9")
            ...
            dependency("com.alipay.sdk:alipay-sdk-java:4.39.271.ALL")
            // sdk - tencent
            dependency("com.qcloud:cos_api:5.6.237")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.1145")
            ...
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-iai:3.1.1143")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-hunyuan:3.1.1145")
            // commons
