...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("com.alibaba:fastjson:2.0.46")
            ...
            dependency("com.squareup.okio:okio:3.8.0")
            dependency("com.google.guava:guava:33.0.0-jre")
            dependency("joda-time:joda-time:2.12.7")
            dependency("com.github.oshi:oshi-core-java11:6.4.12")
            ...
            // sdks
            dependency("io.minio:minio:8.5.8")
            ...
            dependency("com.alibaba:dashscope-sdk-java:2.10.1")
            ...
            dependency("com.aliyun:dingtalk:2.0.84")
            ...
            dependency("com.alipay.sdk:alipay-sdk-java:4.38.200.ALL")
            dependency("com.qcloud:cos_api:5.6.205")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.964")
            ...
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-tmt:3.1.960")
