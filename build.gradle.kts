...
allprojects {
    ...
    dependencyManagement {
        imports {
            ...
            mavenBom("cn.hutool:hutool-bom:5.8.24")
        ...
        dependencies {
            ...
            dependency("org.redisson:redisson:3.25.2")
            dependency("org.redisson:redisson-spring-data-31:3.25.2")
            dependency("org.redisson:redisson-spring-boot-starter:3.25.2")
            // others
            ...
            dependency("com.aliyun:dingtalk:2.0.71")
            ...
            dependency("com.aliyun.oss:aliyun-sdk-oss:3.17.3")
            dependency("com.alipay.sdk:alipay-sdk-java:4.38.170.ALL")
            dependency("com.qcloud:cos_api:5.6.191")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.930")
            ...
            dependency("com.larksuite.oapi:oapi-sdk:2.1.0")
            // commons
