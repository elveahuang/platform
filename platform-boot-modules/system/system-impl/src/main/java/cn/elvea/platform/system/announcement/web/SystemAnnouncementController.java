...
import cn.elvea.platform.system.announcement.model.request.SystemAnnouncementDeleteRequest;
...
public class SystemAnnouncementController extends AbstractController {
    ...
    public R<?> save(@Valid SystemAnnouncementForm form) {
